...
class HCSR04:
    ...
    def __init__(self, gpio_func_trig, gpio_func_echo, echo_timeout_us=500*2*30):
        """
        gpio_func_trig: Output pin to send pulses of type GPIO.****
        gpio_func_echo: Readonly pin to measure the distance. The pin should be protected with 1k resistor. type: GPIO.***
